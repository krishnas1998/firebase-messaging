 ...
 * @param {string} accessToken - Access token generated by google jwt.
 * @param {string[]} registrationTokenOrTokens - The registration token or an array of
...
*
* @param {string} accessToken - Access token generated by google jwt.
* @param {string[]} registrationTokenOrTokens - A token or array of registration tokens
